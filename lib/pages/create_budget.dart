...
class _CreateBudgetState extends State<CreateBudget> {
  ...
  Future<void> expense() async {
    ...
    if (validate()) {
      if (double.parse(provider.balance!) >=
          double.parse(amountController.text)) {
        setState(() {
          isLoading = true;
        });
        try {
          await provider.addBudget(amountController.text, itemController.text,
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text("Your balance is low, try topping up !"),
          ),
        );
      }
    }
            ...
            child: ListView(
              children: [
                ...
                ElevatedButton(
                  ...
                  onPressed: expense,
                  child: Text(
                    isLoading ? "Processing" : "Create Budget",
